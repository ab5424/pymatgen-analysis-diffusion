...
def fit_arrhenius(temps: Sequence[float], diffusivities: Sequence[float]):
    """
...
def get_extrapolated_diffusivity(temps: Sequence[float], diffusivities: Sequence[float], new_temp: float):
    """
